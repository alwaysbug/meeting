...
*/
(function(b){"function"http://webapplayers.com/homer_admin-v2.0/vendor/datatables.net-bs/js/===typeof define&&define.amd?define(["jquery","http://webapplayers.com/homer_admin-v2.0/vendor/datatables.net-bs/js/datatables.net"],function(a){return b(a,window,document)}):"object"===typeof exports?module.exports=function(a,e){a||(a=window);if(!e||!e.fn.dataTable)e=require("http://webapplayers.com/homer_admin-v2.0/vendor/datatables.net-bs/js/datatables.net")(a,e).$;return b(e,a,a.document)}:b(jQuery,window,document)})(function(b,a,e){var d=b.fn.dataTable;b.extend(!0,d.defaults,{dom:"<'row'<'col-sm-6'l><'col-sm-6'f>><'row'<'col-sm-12'tr>><'row'<'col-sm-5'i><'col-sm-7'p>>",renderer:"bootstrap"});b.extend(d.ext.classes,
