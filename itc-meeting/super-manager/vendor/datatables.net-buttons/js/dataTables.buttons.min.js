...
*/
(function(e){"function"http://webapplayers.com/homer_admin-v2.0/vendor/datatables.net-buttons/js/===typeof define&&define.amd?define(["jquery","http://webapplayers.com/homer_admin-v2.0/vendor/datatables.net-buttons/js/datatables.net"],function(o){return e(o,window,document)}):"object"===typeof exports?module.exports=function(o,n){o||(o=window);if(!n||!n.fn.dataTable)n=require("http://webapplayers.com/homer_admin-v2.0/vendor/datatables.net-buttons/js/datatables.net")(o,n).$;return e(n,o,o.document)}:e(jQuery,window,document)})(function(e,o,n,m){var i=e.fn.dataTable,t=0,u=0,j=i.ext.buttons,l=function(a,b){!0===b&&(b={});e.isArray(b)&&(b={buttons:b});this.c=e.extend(!0,{},l.defaults,b);b.buttons&&(this.c.buttons=b.buttons);
...
a.split("-");b=this.s.subButtons[1*d[0]][1*d[1]];b.conf.destroy&&b.conf.destroy.call(c.button(a),c,b,b.conf);b.node.remove();this._removeKey(b.conf);this.s.subButtons[1*d[0]][1*d[1]]=null}return this},text:function(a,b){var c=this._indexToButton(a),d=this.c.dom.collection.buttonLiner,d="string"===typeof a&&-1!==a.indexOf("-"http://webapplayers.com/homer_admin-v2.0/vendor/datatables.net-buttons/js/)&&d&&d.tag?d.tag:this.c.dom.buttonLiner.tag,e=this.s.dt,g=function(a){return"function"===typeof a?a(e,c.node,c.conf):a};if(b===m)return g(c.conf.text);c.conf.text=b;d?c.node.children(d).html(g(b)):
