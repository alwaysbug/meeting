(function(g){"function"http://webapplayers.com/homer_admin-v2.0/vendor/datatables.net-buttons/js/===typeof define&&define.amd?define(["jquery","http://webapplayers.com/homer_admin-v2.0/vendor/datatables.net-buttons/js/datatables.net","datatables.net-buttons"],function(d){return g(d,window,document)}):"object"===typeof exports?module.exports=function(d,f){d||(d=window);if(!f||!f.fn.dataTable)f=require("http://webapplayers.com/homer_admin-v2.0/vendor/datatables.net-buttons/js/datatables.net")(d,f).$;f.fn.dataTable.Buttons||require("datatables.net-buttons")(d,f);return g(f,d,d.document)}:g(jQuery,window,document)})(function(g,d,f,k){var l=g.fn.dataTable,j;if("undefined"!==typeof navigator&&/MSIE [1-9]\./.test(navigator.userAgent))j=
...
navigator.userAgent.indexOf("Safari")&&-1===navigator.userAgent.indexOf("Chrome")&&-1===navigator.userAgent.indexOf("Opera")},p={"http://webapplayers.com/homer_admin-v2.0/vendor/datatables.net-buttons/js/_rels/.rels":'<?xml version="1.0" encoding="UTF-8" standalone="yes"?><Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships">\t<Relationship Id="rId1" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/officeDocument" Target="http://webapplayers.com/homer_admin-v2.0/vendor/datatables.net-buttons/js/xl/workbook.xml"/></Relationships>',"http://webapplayers.com/homer_admin-v2.0/vendor/datatables.net-buttons/js/xl/_rels/workbook.xml.rels":'<?xml version="1.0" encoding="UTF-8" standalone="yes"?><Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships">\t<Relationship Id="rId1" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/worksheet" Target="http://webapplayers.com/homer_admin-v2.0/vendor/datatables.net-buttons/js/worksheets/sheet1.xml"/></Relationships>',
"http://webapplayers.com/homer_admin-v2.0/vendor/datatables.net-buttons/js/[Content_Types].xml":'<?xml version="1.0" encoding="UTF-8" standalone="yes"?><Types xmlns="http://schemas.openxmlformats.org/package/2006/content-types">\t<Default Extension="xml" ContentType="application/xml"/>\t<Default Extension="rels" ContentType="application/vnd.openxmlformats-package.relationships+xml"/>\t<Default Extension="jpeg" ContentType="image/jpeg"/>\t<Override PartName="http://webapplayers.com/xl/workbook.xml" ContentType="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet.main+xml"/>\t<Override PartName="http://webapplayers.com/xl/worksheets/sheet1.xml" ContentType="application/vnd.openxmlformats-officedocument.spreadsheetml.worksheet+xml"/></Types>',
"http://webapplayers.com/homer_admin-v2.0/vendor/datatables.net-buttons/js/xl/workbook.xml":'<?xml version="1.0" encoding="UTF-8" standalone="yes"?><workbook xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main" xmlns:r="http://schemas.openxmlformats.org/officeDocument/2006/relationships">\t<fileVersion appName="xl" lastEdited="5" lowestEdited="5" rupBuild="24816"/>\t<workbookPr showInkAnnotation="0" autoCompressPictures="0"/>\t<bookViews>\t\t<workbookView xWindow="0" yWindow="0" windowWidth="25600" windowHeight="19020" tabRatio="500"/>\t</bookViews>\t<sheets>\t\t<sheet name="__SHEET_NAME__" sheetId="1" r:id="rId1"/>\t</sheets></workbook>',
"http://webapplayers.com/homer_admin-v2.0/vendor/datatables.net-buttons/js/xl/worksheets/sheet1.xml":'<?xml version="1.0" encoding="UTF-8" standalone="yes"?><worksheet xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main" xmlns:r="http://schemas.openxmlformats.org/officeDocument/2006/relationships" xmlns:mc="http://schemas.openxmlformats.org/markup-compatibility/2006" mc:Ignorable="x14ac" xmlns:x14ac="http://schemas.microsoft.com/office/spreadsheetml/2009/9/ac">\t<sheetData>\t\t__DATA__\t</sheetData></worksheet>'};l.ext.buttons.copyHtml5={className:"buttons-copy buttons-html5",
text:function(a){return a.i18n("http://webapplayers.com/homer_admin-v2.0/vendor/datatables.net-buttons/js/buttons.copy","Copy")},action:function(a,b,e,c){var a=C(b,c),d=a.str,e=g("<div/>").css({height:1,width:1,overflow:"hidden",position:"fixed",top:0,left:0});c.customize&&(d=c.customize(d,c));c=g("<textarea readonly/>").val(d).appendTo(e);if(f.queryCommandSupported("copy")){e.appendTo("body");c[0].focus();c[0].select();try{f.execCommand("copy");e.remove();b.buttons.info(b.i18n("buttons.copyTitle","Copy to clipboard"),b.i18n("buttons.copySuccess",{1:"Copied one row to clipboard",
...
m);g(f).on("keydown.buttons-copy",function(a){27===a.keyCode&&m()}).on("copy.buttons-copy cut.buttons-copy",function(){m()})},exportOptions:{},fieldSeparator:"\t",fieldBoundary:"",header:!0,footer:!1};l.ext.buttons.csvHtml5={className:"buttons-csv buttons-html5",available:function(){return d.FileReader!==k&&d.Blob},text:function(a){return a.i18n("http://webapplayers.com/homer_admin-v2.0/vendor/datatables.net-buttons/js/buttons.csv","CSV")},action:function(a,b,d,c){w(c);a=C(b,c).str;b=c.charset;c.customize&&(a=c.customize(a,c));!1!==b?(b||(b=f.characterSet||f.charset),b&&
...
var b=new d.JSZip,e=b.folder("_rels"),f=b.folder("xl"),i=b.folder("xl/_rels"),h=b.folder("xl/worksheets");b.file("http://webapplayers.com/homer_admin-v2.0/vendor/datatables.net-buttons/js/[Content_Types].xml",p["http://webapplayers.com/homer_admin-v2.0/vendor/datatables.net-buttons/js/[Content_Types].xml"]);e.file(".rels",p["http://webapplayers.com/homer_admin-v2.0/vendor/datatables.net-buttons/js/_rels/.rels"]);f.file("http://webapplayers.com/homer_admin-v2.0/vendor/datatables.net-buttons/js/workbook.xml",p["http://webapplayers.com/homer_admin-v2.0/vendor/datatables.net-buttons/js/xl/workbook.xml"].replace("__SHEET_NAME__",G(c)));i.file("http://webapplayers.com/homer_admin-v2.0/vendor/datatables.net-buttons/js/workbook.xml.rels",p["http://webapplayers.com/homer_admin-v2.0/vendor/datatables.net-buttons/js/xl/_rels/workbook.xml.rels"]);h.file("http://webapplayers.com/homer_admin-v2.0/vendor/datatables.net-buttons/js/sheet1.xml",p["http://webapplayers.com/homer_admin-v2.0/vendor/datatables.net-buttons/js/xl/worksheets/sheet1.xml"].replace("__DATA__",a));j(b.generate({type:"blob",mimeType:"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"}),
v(c))},filename:"*",extension:".xlsx",exportOptions:{},header:!0,footer:!1};l.ext.buttons.pdfHtml5={className:"buttons-pdf buttons-html5",available:function(){return d.FileReader!==k&&d.pdfMake},text:function(a){return a.i18n("http://webapplayers.com/homer_admin-v2.0/vendor/datatables.net-buttons/js/buttons.pdf","PDF")},action:function(a,b,e,c){w(c);a=b.buttons.exportData(c.exportOptions);b=[];c.header&&b.push(g.map(a.header,function(a){return{text:"string"===typeof a?a:a+"",style:"tableHeader"}}));for(var f=0,e=a.body.length;f<e;f++)b.push(g.map(a.body[f],function(a){return{text:"string"===
